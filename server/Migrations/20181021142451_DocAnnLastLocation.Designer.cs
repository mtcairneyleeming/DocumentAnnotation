...
namespace DocumentAnnotation.Migrations
{
    ...
    [Migration("20181021142451_DocAnnLastLocation")]
    partial class DocAnnLastLocation
    {
            ...
            modelBuilder.Entity("Document.Models.Document", b =>
                {
                    ...
                    b.OwnsOne("Document.Models.Location", "LastLocation", b1 =>
                        {
                            b1.Property<int>("DocumentAnnotationId");
                            ...
                            b1.HasOne("Document.Models.Document")
                                .WithOne("LastLocation")
                                .HasForeignKey("Document.Models.Location", "DocumentAnnotationId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("Document.Models.Highlight", b =>
                {
                    ...
                    b.OwnsOne("Document.Models.Location", "Location", b1 =>
                        {
